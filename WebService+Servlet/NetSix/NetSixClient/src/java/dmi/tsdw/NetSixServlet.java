...
public class NetSixServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            //out.println(getDisponibilita(name, numeroSerie) + "<br>");
            out.println(getDisponibilita_1(name, numeroSerie) + "<br>");
        }
    }
    ...
    private static String getDisponibilita(java.lang.String serie, int episodi) {
        dmi.tsdw.NetSixWS_Service service = new dmi.tsdw.NetSixWS_Service();
        dmi.tsdw.NetSixWS port = service.getNetSixWSPort();
        return port.getDisponibilita(serie, episodi);
    }

    private static String getDisponibilita_1(java.lang.String arg0, int arg1) {
