 ...
 * 
 */
@WebServiceClient(name = "temperatureWS", targetNamespace = "http://tsdw.dmi/", wsdlLocation = "http://localhost:8080/temperatureWebService/temperatureWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TEMPERATUREWS_QNAME = new QName("http://tsdw.dmi/", "temperatureWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/temperatureWebService/temperatureWS?wsdl");
    ...
    public TemperatureWS getTemperatureWSPort() {
        return super.getPort(new QName("http://tsdw.dmi/", "temperatureWSPort"), TemperatureWS.class);
    }
    ...
    public TemperatureWS getTemperatureWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://tsdw.dmi/", "temperatureWSPort"), TemperatureWS.class, features);
    }
